...
export default function LogIn() {
  return (
    <div className="w-screen h-screen bg-[#FFFF] text-[#0D1F40] flex flex-col gap-[20px] px-[10%] justify-center">
      ...
      <Link href="/map" className="w-full flex justify-items-center">
        <div className=" bg-[#0D1F40] w-full h-[60px] rounded-lg text-white flex justify-center items-center font-semibold">
          Log in
        </div>
      </Link>
